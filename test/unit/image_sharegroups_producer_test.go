...
func TestImageShareGroup_Producer_List_Images(t *testing.T) {
	...
	images, err := base.Client.ListImageShareGroupImages(context.Background(), 1234, &linodego.ListOptions{})
	assert.NoError(t, err)
...
func TestImageShareGroup_Producer_List_Members(t *testing.T) {
	...
	members, err := base.Client.ListImageShareGroupMembers(context.Background(), 1234, &linodego.ListOptions{})
	assert.NoError(t, err)
