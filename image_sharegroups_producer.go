...
func (c *Client) ImageShareGroupAddImages(ctx context.Context, imageShareGroupID int, opts ImageShareGroupAddImagesOptions) ([]Image, error) {
...
func (c *Client) ImageShareGroupUpdateImage(ctx context.Context, imageShareGroupID int, imageID string, opts ImageShareGroupUpdateImageOptions) (*Image, error) {
...
func (c *Client) ListImageShareGroupsContainingPrivateImage(ctx context.Context, privateImageID int, opts *ListOptions) ([]ProducerImageShareGroup, error) {
...
// ListImageShareGroupImages lists the Images in the provided ImageShareGroup owned by the producer.
func (c *Client) ListImageShareGroupImages(ctx context.Context, imageShareGroupID int, opts *ListOptions) ([]Image, error) {
...
// ListImageShareGroupMembers lists the ImageShareGroupMembers of the provided ImageShareGroup owned by the producer.
func (c *Client) ListImageShareGroupMembers(ctx context.Context, imageShareGroupID int, opts *ListOptions) ([]ImageShareGroupMember, error) {
